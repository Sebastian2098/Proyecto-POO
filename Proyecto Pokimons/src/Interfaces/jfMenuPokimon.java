 ...
 * @author alumno
 */
public class jfMenuPokimon extends javax.swing.JFrame {

    /**
     * Creates new form jfMenuPokimon
     * 
     * 
     */
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Squirtle (AGUA)");

        jLabel6.setText("Cyndaquil (FUEGO)");

        jLabel7.setText("Chango (HIERBA)");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/brs.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jfMenuPokimon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jfMenuPokimon().setVisible(true);
            }
        });
    }
